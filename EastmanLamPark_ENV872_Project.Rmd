...
```{r}
titles <- c("Variable", "Units", "Source")
source_1 <- c("Mean Sea Level", "ft", "NOAA Tide's & Currents")
source_2<- c("Mean Tide Level", "ft", "NOAA Tide's & Currents")
source_3 <-c("Daily Temperature", "Celcius", "NOAA's National Data Buoy Center")

rbind(titles, source_1, source_2, source_3)
```

| Variable | Units | Source |
|Mean Sea Level| ft| NOAA Tide's & Currents |
|Mean Tide Level| ft| NOAA Tide's & Currents |
|Daily Temperature| Celcius| NOAA's National Data Buoy Center |
